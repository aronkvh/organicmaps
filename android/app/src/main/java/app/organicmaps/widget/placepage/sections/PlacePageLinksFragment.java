...
public class PlacePageLinksFragment extends Fragment implements Observer<MapObject>
{
  ...
  public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState)
  {
    ...
    mKayak.setOnClickListener((v) -> Utils.openUrl(requireContext(), getExternalUrl(mMapObject)));
    mKayak.setOnLongClickListener((v) -> {
      PlacePageUtils.copyToClipboard(requireContext(), mFrame, getExternalUrl(mMapObject));
      return true;
    });
